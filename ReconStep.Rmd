...
# Call function to generate bib file for this project from Meko's hugh bib file. User
# can ignore this code. Meko may as well ignore it to, because this function clean_bib
# fails to pull bibtex reference whose entries are more than one name (e.g., Meko&Woodhouse2020)
